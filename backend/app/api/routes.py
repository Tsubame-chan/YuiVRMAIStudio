...
def health(settings: Settings = Depends(get_settings)) -> HealthResponse:
    ...
    return HealthResponse(
        ...
        features={
            ...
            "local_aivis_tts": settings.tts_provider == "aivis",
...
def config(settings: Settings = Depends(get_settings)) -> ConfigResponse:
    ...
    if settings.aivis_base_url:
        tts_providers.append("aivis")
    ...
    return ConfigResponse(
        ...
        tts_recommendation={
            "default": "voicevox",
            "mobile_default": "voicevox_core",
            "desktop_quality": "aivis",
            "macos_apple_silicon": "irodori_mlx",
            "windows_nvidia": "irodori_server",
            "windows_cpu": "voicevox",
            "aivis_label": "AivisSpeech HD",
            "irodori_mlx_label": "Irodori MLX VoiceDesign",
            "irodori_server_label": "Irodori-TTS-Server for Windows NVIDIA",
        },
        tts_voice_options=voice_options_for_config(tts_providers),
        tts_default_voice=default_voices_for_config(tts_providers),
        stt_provider=settings.stt_provider,
