...
namespace YuiPhysicalAI.Editor
{
    public static class YuiPublicWindowsBuildTools
    {
        ...
        private const string WindowsPublicBuildDirectory = "../../builds/YuiVRMAIStudio_WindowsPublicBeta_v0.2.0-beta.1";
        private const string MacPublicBuildDirectory = "../../builds/YuiVRMAIStudio_MacOSPublicBeta_v0.2.0-beta.1";
