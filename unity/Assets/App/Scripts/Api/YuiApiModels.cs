...
namespace YuiPhysicalAI.Api
{
    ...
    public sealed class ProviderStatusResponse
    {
        ...
        public ProviderSystemStatus Backend { get; set; }

        [JsonProperty("database")]
        public ProviderSystemStatus Database { get; set; }

        [JsonProperty("providers")]
        public Dictionary<string, ProviderStatusItem> Providers { get; set; }
    }

    [Serializable]
    public sealed class ProviderSystemStatus
    {
        [JsonProperty("status")]
        public string Status { get; set; }
